...
class MemoGridRecycleAdapter(realmResult: OrderedRealmCollection<Memo>, context: Context)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderOfGridRecycleView {
        val currView = LayoutInflater.from(parent?.context).inflate(R.layout.item_memo_grid, parent, false)
        view = currView
    ...
    inner class ViewHolderOfGridRecycleView(view: View): RecyclerView.ViewHolder(view){
